...
;▼▲▼▲▼▲▼▲▼▲▼▲▼▲▼▲▼▲▼▲▼▲▼▲
   ...
   while 1
		 ...
		 ; めくり後処理グループA（各誌で分岐）
			Select
			;============================================
			Case $EndMode = $EM_DAYSMG
			;============================================
				  ; daysの全画面が中断された検出（横）　★これはもう不要？
...
; MouseMove($f[$XXX],$f[$YYY])
   ...
   ;============================================
	...
	;============================================
						  ; ■DAYS連続　
							MsgBOX( 0, "PAUSE", "DAYS(単) Auto End Detect" )
							$startstop=0
   ;============================================
					Case $EndMode = $EM_DAYSMG
	;============================================
						  ; ■DAYS連続　
							MsgBOX( 0, "PAUSE", "DAYS（雑） Auto End Detect" )
							$startstop=0
   ;============================================
...
;============================================
	Case $EndMode = $EM_DAYSSGL
		; 左キー
		$PageKind = 3
		MsgBOX( 0, "PAUSE", "★コミックDAYS（単）" )
	Case $EndMode = $EM_DAYSMG
		; 左キー
		$PageKind = 3
		MsgBOX( 0, "PAUSE", "★コミックDAYS(雑)" )
;============================================
	Case $EndMode = $EM_EBOOK
		; 左キー
		$PageKind = 3
